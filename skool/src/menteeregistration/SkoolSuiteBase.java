...
public class SkoolSuiteBase extends SuiteBase{	
	...
	String randoms = "MentorTest" + number ;
	return randoms;
	...
	public void NewMentorSign_up(){
		try{
			...
			driver.manage().timeouts().implicitlyWait(50, TimeUnit.SECONDS);
			driver.findElement(By.xpath(Object.getProperty("select_mentor"))).click();  
			Thread.sleep(5000);
			driver.findElement(By.xpath(Object.getProperty("click_signup"))).click();
			driver.manage().timeouts().implicitlyWait(50, TimeUnit.SECONDS);
		    Add_Log.info("NewMentorSign_up--login successful");
		}catch(Throwable e){
			Add_Log.error("NewMentorSign_up--login failed");
			throw new RuntimeException(e);
		}
	}
	
	
	public void NewMentorBasicInformation(){
		try{
			driver.findElement(By.xpath(Object.getProperty("enter_firstname"))).sendKeys("TestFirstName");
			driver.findElement(By.xpath(Object.getProperty("enter_lastname"))).sendKeys("TestFirstName");
			...
			new Select (driver.findElement(By.xpath(Object.getProperty("select_year")))).selectByVisibleText("1988");
			...
			driver.findElement(By.xpath(Object.getProperty("Confirm_password"))).sendKeys("TestPa55w0rd");
			driver.findElement(By.xpath(Object.getProperty("enter_zipcode"))).sendKeys("89076");
			driver.findElement(By.xpath(Object.getProperty("enter_mobiel"))).sendKeys("(498)345-4566");
			driver.findElement(By.xpath(Object.getProperty("enter_skype_id"))).sendKeys("testskype");
			...
			Thread.sleep(300);
			driver.manage().timeouts().implicitlyWait(50, TimeUnit.SECONDS);
		    Add_Log.info("NewMentorBasicInformation-- successful");
		}catch(Throwable e){
			Add_Log.error("NewMentorBasicInformation-- failed");
			throw new RuntimeException(e);
		}
	}
	...
	public void NewMentorType(){
		try{
			driver.findElement(By.xpath(Object.getProperty("Click_workstatus_prof"))).click(); 
			driver.manage().timeouts().implicitlyWait(50, TimeUnit.SECONDS);
			driver.findElement(By.xpath(Object.getProperty("Test_Employer"))).sendKeys("Test_Employer");
			driver.findElement(By.xpath(Object.getProperty("Test_Job_Title"))).sendKeys("Test_Job_Title");
			new Select (driver.findElement(By.xpath(Object.getProperty("Yrs_Experience")))).selectByVisibleText("7");
			driver.findElement(By.xpath(Object.getProperty("Test_Linkedin"))).sendKeys("Test_Employer");
			driver.findElement(By.xpath(Object.getProperty("Test_School_Attended"))).sendKeys("Test_Job_Title");
			new Select (driver.findElement(By.xpath(Object.getProperty("Yr_Graduation")))).selectByVisibleText("1989");
			driver.findElement(By.xpath(Object.getProperty("Test_Work_Email"))).sendKeys("prklgc@gmail.com");
			//driver.findElement(By.xpath(Object.getProperty("Test_Confirm_Email"))).sendKeys("Testwork@abc.com");
		    driver.manage().timeouts().implicitlyWait(50, TimeUnit.SECONDS);
		    ...
		    Thread.sleep(1000);
		    new Select (driver.findElement(By.xpath(Object.getProperty("select_city")))).selectByVisibleText("Atka");
		    Thread.sleep(1000);
		    
		    
		    
		    Add_Log.info("NewMentorType-- successful");
		}catch(Throwable e){
			Add_Log.error("NewMentorType-- failed");
			throw new RuntimeException(e);
		}
	}

	
	public void areasAvailable(){
		try{
			driver.findElement(By.xpath(Object.getProperty("tick_college_major"))).click(); 
			new Select (driver.findElement(By.xpath(Object.getProperty("select_field_of_study")))).selectByVisibleText("Applied Sciences");
			driver.findElement(By.xpath(Object.getProperty("tick_field_of_specialization"))).click(); 
			new Select (driver.findElement(By.xpath(Object.getProperty("select_degree")))).selectByVisibleText("MBA");
			...
			Thread.sleep(2000);
			new Select (driver.findElement(By.xpath(Object.getProperty("select_response_time")))).selectByVisibleText("Everyday");
			Thread.sleep(1500);
			//driver.findElement(By.xpath(Object.getProperty("My_Typical_Available_Times"))).sendKeys("There are many variations of passages of Lorem Ipsum available, but the majority have suffered alteration in some form, by injected humour, or randomised words which don't look even slightly believable. If you are going to use a passage of Lorem Ipsum, you need to be sure there isn't anything embarrassing hidden in the middle of text.");
			//Thread.sleep(1500);
			driver.findElement(By.xpath(Object.getProperty("3months"))).click(); 
			Thread.sleep(1500);
			new Select (driver.findElement(By.xpath(Object.getProperty("select_volunteer")))).selectByVisibleText("Yes");
			driver.findElement(By.xpath(Object.getProperty("tick_condition"))).click(); 
			driver.findElement(By.xpath(Object.getProperty("click_creat_acc"))).click(); 
			Add_Log.info("NewMentorType-- successful");
		}catch(Throwable e){
			Add_Log.error("NewMentorType-- failed");
			throw new RuntimeException(e);
	...
	public void ViewEditProfile(){
		try{
			...
			driver.findElement(By.xpath(Object.getProperty("Get_LastName"))).sendKeys("Mantorlastname");
			...
			new Select (driver.findElement(By.xpath(Object.getProperty("Select_Accept_Mentee")))).selectByVisibleText("yes");
			driver.findElement(By.xpath(Object.getProperty("Enter_Edit_Employer"))).clear();
			Thread.sleep(100);
			driver.findElement(By.xpath(Object.getProperty("Enter_Edit_Employer"))).sendKeys("Cisco");
			
			driver.findElement(By.xpath(Object.getProperty("Enter_Edit_JobTitle"))).clear();
			Thread.sleep(100);
			driver.findElement(By.xpath(Object.getProperty("Enter_Edit_JobTitle"))).sendKeys("TestEngineer");
			
			
			new Select (driver.findElement(By.xpath(Object.getProperty("Enter_Edit_Yrs_Exp")))).selectByVisibleText("10");
			driver.findElement(By.xpath(Object.getProperty("Enter_Edit_Linkedin"))).clear();
			Thread.sleep(100);
			driver.findElement(By.xpath(Object.getProperty("Enter_Edit_Linkedin"))).sendKeys("testlinkedin");
			driver.findElement(By.xpath(Object.getProperty("Enter_Edit_LastSch_Att"))).clear();
			Thread.sleep(100);
			driver.findElement(By.xpath(Object.getProperty("Enter_Edit_LastSch_Att"))).sendKeys("SomeText");
			new Select (driver.findElement(By.xpath(Object.getProperty("Select_Edit_Yr_Grd")))).selectByVisibleText("1998");
			driver.findElement(By.xpath(Object.getProperty("Enter_Edit_Work_Email"))).clear();
			Thread.sleep(100);
			driver.findElement(By.xpath(Object.getProperty("Enter_Edit_Work_Email"))).sendKeys("prklgc@gmail.com");
     	    new Select (driver.findElement(By.xpath(Object.getProperty("Select_Edit_Country")))).selectByVisibleText("USA");
		    Thread.sleep(1000);
			new Select (driver.findElement(By.xpath(Object.getProperty("Select_Edit_State")))).selectByVisibleText("California");
			Thread.sleep(1000);
			new Select (driver.findElement(By.xpath(Object.getProperty("Select_Edit_City")))).selectByVisibleText("American Canyon");
			Thread.sleep(1000);
			...
			driver.findElement(By.xpath(Object.getProperty("Click_Edit_Accountin"))).click(); 
			new Select (driver.findElement(By.xpath(Object.getProperty("Select_Edit_Masters")))).selectByVisibleText("Masters");
			driver.findElement(By.xpath(Object.getProperty("Enter_Edit_Aboutme"))).clear();
			Thread.sleep(100);
			driver.findElement(By.xpath(Object.getProperty("Enter_Edit_Aboutme"))).sendKeys("This is not about me ");
			driver.findElement(By.xpath(Object.getProperty("Click_Edit_Both"))).click(); 
			
			driver.findElement(By.xpath(Object.getProperty("Click_Edit_Save"))).click(); 
			driver.manage().timeouts().implicitlyWait(50, TimeUnit.SECONDS);
	...
	public void Menteorsearchmentorbyfirstname(){
		try{
			...
			driver.findElement(By.xpath(Object.getProperty("Search_School_Type"))).sendKeys("TestSchool");
			driver.findElement(By.xpath(Object.getProperty("Search_Click_Go"))).click();
			driver.findElement(By.xpath(Object.getProperty("Search_School_Type"))).clear();
			Thread.sleep(200);
	...
	public void Menteorsearchadvanced(){
		try{
		    ...
		    Add_Log.info("Menteorsearchadvanced-- successful");
		}catch(Throwable e){
			Add_Log.error("Menteorsearchadvanced-- failed");
			throw new RuntimeException(e);
		}
	}
	...
	public void Menteorsearchmajor(){
		try{
		    ...
		    Add_Log.info("Menteorsearchmajor-- successful");
		}catch(Throwable e){
			Add_Log.error("Menteorsearchmajor-- failed");
			throw new RuntimeException(e);
		}
	}
