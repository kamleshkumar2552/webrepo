...
public class MentorSignup extends SkoolSuiteBase{
	...
	public void checkCaseToRun() throws IOException{
		...
		FilePath = TestCaseListExcelmenteeregistration;	
	...
	//		System.out.println(DataCol4);
			System.out.println(ExpectedResult);
			
	
			//MentorSignup
		    NewMentorSign_up();
			NewMentorBasicInformation();
			NewMentorType();
			areasAvailable();
		  ...
		  @Test (description="Email fetch",priority=2)
			 ...
			 public void LoginAftermailvarification() throws Exception
			    {
			    	try{
			    		...
			    		ViewEditProfile(); 
			    		logoutandlogin();
			    		Menteorsearchmentorbyfirstname();
			    		Menteorsearchadvanced();
			    	    Menteorsearchmajor();
